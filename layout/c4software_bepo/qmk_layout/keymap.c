 ...
 * | ESC    | "      | <      | >      | (      | )      | %      | VOL-   | VOL+   | @      | +      | -      | /      | *      | =      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | TAB    | B      | E_ACUT | P      | O      | E_GRAV | $      | E_CIRC | V      | D      | L      | J      | Z      | C_CEDIL| DEL    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | RALT   | A      | U      | I      | E      | ,      |        | C      | T      | S      | R      | N      | M      | W      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LSHIFT | A_GRAVE| Y      | X      | .      | K      |        | ’      | Q      | G      | H      | F      | RALT   | UP     | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LCTRL  | LALT   | FN     | LGUI   | ENTER  | ENTER  | SPACE  | SPACE  | BACKSP | BACKSP | RGUI   | FN     | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_BP] = { /* BepoDev */
  ...
  { KC_LCTL, KC_LALT,    MO(_FN),    KC_LGUI, KC_ENT,  KC_ENT,     KC_SPC,     KC_SPC,  KC_BSPC, KC_BSPC, KC_RGUI, MO(_FN), KC_LEFT,  KC_DOWN,  KC_RGHT  },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_MINS, KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI },
  { KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, KC_TRNS, KC_TRNS, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, KC_TRNS, RGB_SAI, RGB_SAD, RGB_VAI },
  { KC_TRNS, KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  KC_TRNS, KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_ENT,  KC_TRNS, RGB_VAD, KC_HOME, RGB_HUD },
  { RESET,   KC_TRNS, MO(_FN), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_0, KC_KP_0, KC_PDOT, MO(_FN), KC_TRNS, KC_TRNS, KC_END,  KC_TRNS },
 }
};
