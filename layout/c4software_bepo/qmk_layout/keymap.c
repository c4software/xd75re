...
/* Native BEPO for compatible computer
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | ESC    | "      | <      | >      | (      | )      | %      |        |        | @      | +      | -      | /      | *      | =      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | A_GRAV | Y      | X      | .      | K      | BACKSP | BACKSP | ’      | Q      | G      | H      | F      | HOME   | END    |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LALT   | LGUI   | FN     | SPACE  | SPACE  | LEFT   | UP     | DOWN   | RIGHT  | SPACE  | SPACE  | FN     | RGUI   | RALT   |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_BP] = { /* Bepo */
  ...
  { KC_LSFT, BP_A_GRAVE, BP_Y,       BP_X,    BP_DOT,  BP_K,       KC_BSPC, KC_BSPC, BP_APOS, BP_Q,    BP_G,    BP_H,     BP_F,     KC_HOME, KC_END   },
  { KC_LCTL, KC_LALT,    KC_LGUI,    MO(_FN), KC_SPC,  KC_SPC,     KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, KC_SPC,  KC_SPC,   MO(_FN),  KC_RGUI, KC_RALT },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { RESET,   KC_TRNS, KC_TRNS, MO(_FN), KC_TRNS, KC_TRNS, KC_KP_0, KP_00, KC_PDOT, KC_PENT, KC_TRNS, MO(_FN), KC_TRNS, KC_TRNS, KC_TRNS },
 }
};
